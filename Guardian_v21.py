...
MODE_CONFIGS = {
    "学习模式": {
        "0": [[9, 0, 11, 0], [14, 0, 17, 0], [19, 0, 21, 0]],
        "1": [[9, 0, 11, 0], [14, 0, 17, 0], [19, 0, 21, 0]],
        "2": [[9, 0, 11, 0], [14, 0, 17, 0], [19, 0, 21, 0]],
        "3": [[9, 0, 11, 0], [14, 0, 17, 0], [19, 0, 21, 0]],
        "4": [[9, 0, 11, 0], [14, 0, 17, 0], [19, 0, 21, 0]],
        "5": [[9, 0, 21, 0]],
        "6": [[9, 0, 21, 0]]
    }
}
...
STATS_DB_FILE = os.path.join(CONFIG_DIR, "stats.db")
BONUS_TIME_FILE = os.path.join(CONFIG_DIR, "bonus.json")
